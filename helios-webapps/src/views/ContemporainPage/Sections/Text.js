    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          <h2 className={classes.title}>La musique contemporaine et Hélios</h2>
...
Au fil des années, leur répertoire s’est enrichi de nombreuses œuvres qui leur sont dédiées, à ce jour une cinquantaine ! Leur détail, -compositeur, titre, date et lieu de création- est énuméré dans la rubrique "Oeuvres dédiées"
        ...
        <GridItem>
        <div className={classes.subdescr}>
        Hélios a eu eu le plaisir de travailler avec tous ses compositeurs.
        ...
        <GridItem>
          <div className={classes.subdescr}>
            <iframe width="520" height="320"
              src="https://youtube.com/embed/4me3Z9ypBGo" frameBorder="0" allowFullScreen title="Thierry Escaïch, Variations Gothiques">
            </iframe>
