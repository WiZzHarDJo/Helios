      ...
      <GridContainer justify="center">
        ...
        <GridItem>
          <div className={classes.subdescr}>
            Elève de Marcel Bardon au CNR de Paris, Christophe Beau obtient une
            Médaille d'Or (1985), un Premier Prix d'Excellence de violoncelle
            (1986) et un Premier Prix de Virtuosité (1987).En 1988, il entre au
            CNSM de Lyon dans la classe d' Yvan Chiffoleau où il obtient un
        ...
        <GridItem>
          <div className={classes.subdescr}>
            ...
            avec l'Ensemble De nos jours.Depuis 1992, Christophe Beau est membre
            des Virtuoses de France. En 1994, il est Directeur et co-fondateur
            du Festival Musique en Ecrins pendant 13 ans. Il réside à l'Abbaye
            de la Prée de 1995 à 1998 où il participe aux Rencontres Musicales.
          </div>
        </GridItem>
        <GridItem>
          <div className={classes.subdescr}>
