...
import teleramaLogo from "./../../../assets/img/logo/telerama-logo.jpg";
import lacroixLogo from "./../../../assets/img/logo/la-croix-logo.webp";
import radioClassiqueLogo from "./../../../assets/img/logo/radio-classique-logo.png";
import franceBleueLogo from "./../../../assets/img/logo/logo-france-bleu-seo.jpg";
import laMuseLogo from "./../../../assets/img/logo/logo_lamuse.png";
import repCentreLogo from "./../../../assets/img/logo/rep-centre-logo.gif";
import bienPublicLogo from "./../../../assets/img/logo/bien-public-logo.jpg";
import saoneLoireLogo from "./../../../assets/img/logo/saone-loire-logo.png";
import siegenerLogo from "./../../../assets/img/logo/siegener-logo.png";
import indeLogo from "./../../../assets/img/logo/independant-logo.jpg";
import laPresseLogo from "./../../../assets/img/logo/lapresse-logo.png";
import percheLogo from "./../../../assets/img/logo/leperche-logo.png";
import ouestLogo from "./../../../assets/img/logo/ouest-france-logo.jpg";
import dnaLogo from "./../../../assets/img/logo/dna-logo.jpg";
import actionLogo from "./../../../assets/img/logo/action-logo.png";
import lettreMusicienLogo from "./../../../assets/img/logo/musician-letter-logo.jpg";
import cnsmLogo from "./../../../assets/img/logo/cnsm-logo.png";
import bolshoiLogo from "./../../../assets/img/logo/bolshoi-logo-big.gif";
import pariscopeLogo from "./../../../assets/img/logo/pariscope-logo.png";
import traversiereLogo from "./../../../assets/img/logo/traversiere-logo.png";
import crescendoLogo from "./../../../assets/img/logo/crescendo-logo.jpg";
          ...
          <GridContainer>
            <GridItem>
              <div className={classes.typo}>
                <img
                  src={crescendoLogo}
                  alt="Logo Crescendo Magazine"
                  className={classes.pressImg}
                />
                <Quote
            ...
            <GridItem>
              <div className={classes.typo}>
                ...
                <img
                  src={radioClassiqueLogo}
                  alt="Logo Radio Classique"
                  className={classes.roundPressImg}
                />
                <div style={{ width: "100px" }} />
                <Quote
            ...
            <GridItem>
              <div className={classes.typo}>
                <img
                  src={repCentreLogo}
                  alt="Logo La République du Centre"
                  className={classes.pressImg}
                />
                <Quote
            ...
            <GridItem>
              <div className={classes.typo}>
                <img
                  src={saoneLoireLogo}
                  alt="Logo Journal de Saône et Loire"
                  className={classes.pressImg}
                />
                <Quote
            ...
            <GridItem>
              <div className={classes.typo}>
                <div style={{ width: "100px" }} />
                <img
                  src={lettreMusicienLogo}
                  alt="Logo La Lettre du Musicien"
                  className={classes.roundPressImg}
                />
                <div style={{ width: "100px" }} />
                <Quote
