      ...
      <GridContainer justify="center">
        ...
        >
          ...
          <p className={classes.subdescr}>
                Les oeuvres basques pour piano de Charles BORDES figurent sur ce CD, interprétées par François-René Duchâche et Olivier Laville.  <br/><br/>
                Le pianiste François-René Duchâble, qui avait entendu l'Ensemble Hélios en concert, a souhaité que la version originale de la suite Basque, quintette pour flûte et quatuor à cordes, transcrit pour piano et qu'il grave sur le premier CD, constitue le second CD, comme le miroir d'une oeuvre. <br/><br/>
                Cet enregistrement de la Suite Basque est une prise live du concert donné par l'Ensemble Hélios avec Lucie Bessière au second violon lors des Journées Charles Bordes de 2015. <br/><br/>
                CD sorti en 2018
              </p>
          </Col>
        </Row>
        ...
        >
          ...
          <p className={classes.subdescr}>
            ...
            <div className={classes.program}>
              <h3>Extraits : </h3>
              <h5><b>Volkmar ANDREAE</b> (1879-1962)<br/>"Divertimento Op. 43"</h5>
              <h5><b>Armin KAUFMANN</b> (1902-1980)<br/>"Quartett Op. 17"</h5>
              <h5><b>Rui MARTINS</b> (né en 1958)<br/>"Labyrinthe"</h5>
              <h5><b>Alain LOUVIER</b> (né en 1945)<br/>"Eclipse"</h5>
              <h5><b>Jean-René COMBES-DAMIENS</b> (né en 1957)<br/>"Son Ombre"</h5>
            </div>
          </Card>
        </GridItem>
        <GridItem>
        ...
        >
          ...
          <p className={classes.partenaireDescr}>
            ...
            <div className={classes.program}>
              <h3>Extraits : </h3>
              <h5><b>FINZI</b><br/>La lune à la fenêtre</h5>
              <h5><b>PIECHOWSKA</b><br/>Ephémères</h5>
              <h5><b>LACAZE</b><br/>Broken words ; Voyelles pour flûte solo</h5>
              <h5><b>ROTARU</b><br/>Antara; Légende pour flûte solo</h5>
            </div>
          </Card>
        </GridItem>
        <GridItem>
