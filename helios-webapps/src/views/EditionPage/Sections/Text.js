  ...
  return (
    <div className={classes.section}>
      <GridContainer justify="center">
        ...
        <h2 className={classes.title}>Edition musicale et l'Ensemble Hélios</h2>
        </GridItem>
        <GridItem>
        ...
        <GridItem>
          <div className={classes.subdescr}>
          Dans cette collection, l’Ensemble Hélios ré-édite des publications classiques et publie certaines des œuvres dont il est dédicataire, ouvrant à un large public l’accès à son fabuleux répertoire.
          </div>
        </GridItem>
        <GridItem>
          <div className={classes.subdescr}>
          De belles transcriptions viennent aussi l’élargir :
          <div className={classes.subdescrEdition}>•	Plaisir du flûtiste pour les pièces brillantes de Bizet ou Doppler</div>
          <div className={classes.subdescrEdition}>•	Plaisir du public pour les merveilleuses transcriptions des « Préludes » de Debussy ou bien de la « Pavane pour une infante défunte » de Ravel réalisées par Alain Louvier.</div>
          </div>
        </GridItem>
        <GridItem>
          <div className={classes.subdescr}>
          La collection « Ensemble Hélios » laisse une large place au répertoire pédagogique. La formation a élaboré des volumes pédagogiques à destination des jeunes musiciens de premier et second cycles des conservatoires, contenant des œuvres classiques et contemporaines. Ces volumes rencontrent un grand succès.
          </div>
        </GridItem>
        <GridItem>
          <div className={classes.subdescr}>
        ...
        <GridItem>
          <div className={classes.subdescrMid}>
            Parmi lesquelles, les <Link
                to="/oeuvres"
              >
                œuvres dédiées
              </Link> à l’ensemble Hélios par des compositeurs :
          </div>
        </GridItem>
        <GridItem>
        ...
        <GridItem>
          <div className={classes.subdescrEdition}>
          <i>Images de la poésie grecque</i>, de <b>Charles Chayne</b>
          </div>
        </GridItem>
        <GridItem>
          <div className={classes.subdescrEdition}>
        ...
        <GridItem>
          <div className={classes.subdescrEdition}>
          <i>Quartetto en RéM kv 311</i>, de <b>Wolfgang Amadeus Mozart</b>
          </div>
        </GridItem>
        <GridItem>
          <div className={classes.subdescrEdition}>
