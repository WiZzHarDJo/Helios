    ...
    <div className={classes.section}>
      ...
      <div>
        ...
        <GridItem>
          ...
          Elle peut aussi s’organiser autour des classes de flûte, violon, alto, violoncelle par le montage d’œuvres pédagogiques pour les cycles 1 et 2, ou d’œuvres du répertoire pour le cycle 3. <br/>
        ...
        <GridItem>
          ...
          <h4 className={classes.subdescr}>
          L'Ensemble propose un programme qui fait s'entrecroiser son propre répertoire et des ensembles de flûtes des trois cycles ( en duos, trios, quatuors). <br/>
          A un quatuor de Feld dédié à Hélios, par exemple, répond l'exécution d'un trio de flûte par les étudiants du lieu. Le but est de mobiliser les classes de flûte, en générale très actives, et de montrer aux étudiants les aspects différents du travail du compositeur à travers des formations tranchées. <br/>
